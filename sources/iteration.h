...
public:
    ...
    Eigen::MatrixXcd get_ion() { return Ion; }
    Eigen::MatrixXcd get_cont() { return Cont; }
...
private:
    ...
    Eigen::MatrixXcd k_R_k, kk_R, pp_R, p_R_p ,H_non_k, S_non_k, A_matrix_2eq, A_matrix_1eq_dum, A_matrix_1eq,
    S_matrix_2eq, S_matrix_1eq_dum, S_matrix_1eq, S_transformed, U_matrix_1eq_H;
